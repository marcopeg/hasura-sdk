...
export const call = async (payload, options = { throw: true }) => {
  try {
...
export const trackTable = (args = {}, log) => call({
  type: 'track_table',
  args,
}, {
  throw: log !== undefined,
...
export const untrackTable = (args = {}, log) => call({
  type: 'untrack_table',
  args: {
    table: {
      schema: args.schema,
...
export const trackFunctionWithSession = (args = {}, log) => call({
  type: 'track_function',
  version: 2,
  args: {
    function: {
...
export const untrackFunction = (args = {}, log) => call({
...
export const createSelectPermission = (args = {}, log) => call({
